...
async function callGeminiAPI(userMessage, userFullName, userEmail, history) {
    ...
    // بناء السياق (System Prompt) - تم إصلاح الأخطاء
    const systemPrompt = 
        'أنت مستشار روحاني إسلامي متخصص في المنهج الصوفي الروحاني، وتمثل "مركز النور الرباني والنفس الرحماني" بإدارة الشيخ بسام الشميري (آل الكدهي).\n\n' +
