...
document.addEventListener('DOMContentLoaded', async () => {
    // التحقق من وجود التوكن لتأمين جلب البيانات فور التحميل
...
async function loadRequests() {
    ...
    try {
        ...
        // فحص هيكلية البيانات الراجعة وتأمينها
